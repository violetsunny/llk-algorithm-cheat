...
* [标准写法](#标准写法)
  ...
  * [三、归并排序](#三归并排序)
    * [java标准写法](#java标准写法-2)
  * [四、二分查找（折半查找）](#四二分查找折半查找)
    * [java标准写法](#java标准写法-3)
    * [1.旋转排序数组中的最小值](#1旋转排序数组中的最小值)
  * [五、二叉树遍历](#五二叉树遍历)
    * [java标准写法](#java标准写法-4)
  * [六、回溯](#六回溯)
    * [1. 全排列](#1-全排列)
  ...
  * [七、动态规划](#七动态规划)
    * [简单类型](#简单类型)
      * [1. 斐波拉切数列和青蛙跳台阶](#1-斐波拉切数列和青蛙跳台阶)
    * [中等类型](#中等类型)
      * [1. 0-1背包问题](#1-0-1背包问题)
        * [空间优化](#空间优化)
      * [2. 完全背包问题](#2-完全背包问题)
        * [空间优化](#空间优化-1)
        * [先循环容量，再循环物品](#先循环容量再循环物品)
      * [3. 零钱兑换](#3-零钱兑换)
      * [3. 零钱兑换 II](#3-零钱兑换-ii)
      * [3. 组合总和 Ⅳ](#3-组合总和-ⅳ)
      * [3. 完全平方数](#3-完全平方数)
  ...
  * [八、贪心](#八贪心)
    * [1. 股票买卖最佳时机Ⅱ](#1-股票买卖最佳时机ⅱ)
  * [九、位运算和数学公式](#九位运算和数学公式)
    * [1. 二进制中1的个数](#1-二进制中1的个数)
    * [2. 2的幂](#2-2的幂)
    * [3. 两个整数之和](#3-两个整数之和)
    * [4. 只出现一次的数字](#4-只出现一次的数字)
    * [5. 格雷编码-数学公式](#5-格雷编码-数学公式)
    * [6. 多数元素-摩尔投票](#6-多数元素-摩尔投票)
    * [7. 4的幂-取余](#7-4的幂-取余)
    * [8. 数字 1 的个数](#8-数字-1-的个数)
    * [9. 丢失的数字-高斯求和](#9-丢失的数字-高斯求和)
  * [九、图论](#九图论)
    * [拓扑排序](#拓扑排序)
<!-- TOC -->
# 基础
