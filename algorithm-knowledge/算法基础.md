...
list.add();
list.contains();//数组是否包含，只能是简单类型
list.stream().mapToInt(Integer::intValue).toArray();//转int[]
//set
...
````
![img.png](./images/位操作.png)
![img.png](./images/bit操作.png)
